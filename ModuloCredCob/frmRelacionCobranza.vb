...
#End Region
	...
	Private Sub integrarLista()
		...
		If MessageBox.Show("¿Desea generar integrar por empleado" & vbCrLf &
					"las solicitudes cobranza precapturadas?", "Integración de solicitudes de cobranza",
					MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
			'el objeto implementa todas las funciones de generación de cobranza
			Dim integracionSolCobranza As RelacionCobranza.IntegracionPreCapturaCobranza =
				New RelacionCobranza.IntegracionPreCapturaCobranza(SigaMetClasses.DataLayer.Conexion,
				dtpFCobranza.Value.Date, GLOBAL_IDUsuario, 1)
			integracionSolCobranza.CargarListaDocumentos(dtpFCobranza.Value.Date)

			If MessageBox.Show("Se generarán las siguientes solicitudes de cobranza:" & vbCrLf & vbCrLf &
				integracionSolCobranza.MensajeListaDocumentos() & vbCrLf &
				...
				If integracionSolCobranza.ErrorProceso Then
					MessageBox.Show("Ha ocurrido un error:" & vbCrLf &
										_mensajeError & vbCrLf &
										"No fué posible procesar todas las solicitudes de cobranza", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
				Else
					If MessageBox.Show("Se generaron las siguientes solicitudes:" & vbCrLf &
										integracionSolCobranza.MensajeListaSolicitudesGeneradas & vbCrLf &
										"¿Desea imprimirlas?",
				...
				If integracionSolCobranza.ErrorCancelacion Then
					MessageBox.Show("Ha ocurrido un error:" & vbCrLf &
										_mensajeError & vbCrLf &
										"Cancele manualmente las solicitudes siguientes:" & vbCrLf &
										integracionSolCobranza.MensajeListaSolicitudesParaCancelar(),
